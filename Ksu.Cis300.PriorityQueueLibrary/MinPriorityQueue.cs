...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    public class MinPriorityQueue <TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            int prio = h1.Data.Key.CompareTo(h2.Data.Key);
            LeftistTree<KeyValuePair<TPriority, TValue>> root;
            if (prio < 0)
            {
                root = h1;
                LeftistTree<KeyValuePair<TPriority, TValue>> newtree;
        ...
        /// <summary>
        ///  property that gets the priority stored in the root of the leftist heap
        /// </summary>
        public TPriority MinimumPriority
        {
            get
            {
                ...
                else { return _elements.Data.Key; }
            }

        }

        /// <summary>
        /// A method to remove the element with minimum priority and return that element.
        /// </summary>
        /// <returns></returns>
